...
const HrComponent = (props) => {
  return (
      <>
      <div className="flex flex-col   relative mt-20 w-full   h-60   text-inherit bg-inherit content-center  justify-center  items-center text-center" data-aos="fade-up">
